...
public void koudou1(float ue,float sita,int number,int koudoumode,int stoptime,float koudoutime)
{
...
public void zakom(float pex,float pey,int enumber)
{
  if(elife[enumber]==4)
  {
        sfaze++;
...
public void boss(float ex,float ey,int enumber,int life)
{
 push();
  imageMode(CENTER);
...
public void zako(float ex,float ey)
{
  push();
  imageMode(CENTER);
...
public void rezazako(float ex,float ey)
{
  push();
  imageMode(CENTER);
...
public void edamage(float ex,float ey,int type,int enumber)
{
  if(type==0)
    siz=14;
  else if(type==1)
...
public void shot(float kx,float ky)
{
...
public void kougeki1(float ex,float ey,int etcount,int speed,int kakudo,int time,int start,int end,int kazu,int kankaku)
{
...
public void kougekinami(float ex,float ey,int etcount,int speed,int kakuspeed,int kakuhani,int time,int start,int end,int kazu,int kankaku)
{
  nami2=0;
  for(m=0;m<=kazu;m++)
  {
...
public void kougekihajou(float ex,float ey,int etcount,int speed,int kakuhani,int time,int start,int end,int kazu,int hajoukazu,int kankaku)
{
  for(m=0;m<=kazu;m++)
  {
    if((frameCount%time)==m*kankaku)
...
public void kougekireezayoko(float ex,float ey,int number)
{
  noStroke();
  if(reza[number]<30)
  {
...
public void bossrezayoko(float ex,float ey,int number,int endreza)
{
  push();
  noStroke();
  rectMode(CENTER);
...
public void bossrezayokol(float ex,float ey,int number,int endreza)
{
  push();
  noStroke();
  rectMode(CENTER);
...
public void kougekireezatate(float ex,float ey,int number)
{
  noStroke();
  if(reza[number]<30)
  {
...
public void itemjuu(int x,float y,int mode)
{
  if(shotmode!=mode)
  {
    push();
...
public void itemdebafu(int x,float y,int item)
{
  ...
  public void settings() {  size(1067,600); }
